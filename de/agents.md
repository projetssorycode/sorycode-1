...
Es gibt zwei Arten von Agenten in SoryCode; Primäragenten und Subagenten.
...
SoryCode verfügt über zwei integrierte Primäragenten: **Build** und **Plan**. Auch
...
Konfigurieren Sie Agenten in Ihrer `sorycode.json`-Konfigurationsdatei:
...
Wenn keine Temperatur angegeben ist, verwendet SoryCode modellspezifische Standardwerte; typischerweise 0 für die meisten Modelle, 0.55 für Qwen-Modelle.
...
Dieser Pfad ist relativ zum Speicherort der Konfigurationsdatei. Dies funktioniert sowohl für die globale SoryCode-Konfiguration als auch für die projektspezifische Konfiguration.
...
Die Modell-ID in Ihrer SoryCode-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise [SoryCode Zen](/docs/zen) verwenden, würden Sie `sorycode/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
...
:::tip
Führen Sie `sorycode models` aus, um eine Liste der verfügbaren Modelle anzubieten.
:::
