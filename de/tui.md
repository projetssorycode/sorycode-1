...
SoryCode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet SoryCode die TUI im aktuellen Verzeichnis.
...
In der SoryCode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu SoryCode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet SoryCode. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `sorycode.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `SORYCODE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
