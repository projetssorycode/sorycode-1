...
Erstellen Sie `.sorycode/commands/test.md`:
...
Sie können benutzerdefinierte Befehle über die SoryCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem SoryCode [config](/docs/config):
...
- Global: `~/.config/sorycode/commands/`
- Pro Projekt: `.sorycode/commands/`
...
SoryCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
