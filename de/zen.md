...
SoryCode Zen ist eine vom SoryCode-Team getestete und verifizierte Modellliste.

:::note
SoryCode Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in SoryCode.
Du meldest dich bei SoryCode Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit SoryCode funktionieren.
:::
...
SoryCode Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

SoryCode Zen funktioniert wie jeder andere Provider in SoryCode.

1. Melde dich bei **<a href={console}>SoryCode Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle SoryCode Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner SoryCode-Konfiguration hat das Format `sorycode/<model-id>`.
Fuer GPT 5.2 Codex verwendest du zum Beispiel `sorycode/gpt-5.2-codex`.
...
- MiniMax M2.5 Free ist fuer begrenzte Zeit auf SoryCode verfuegbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das fuer begrenzte Zeit kostenlos auf SoryCode verfuegbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben SoryCode Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und SoryCode weiter mit anderen Providern nutzen kannst