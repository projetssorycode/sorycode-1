Mit der Share-Funktion erstellst du oeffentliche Links zu SoryCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht SoryCode Folgendes:
...
SoryCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt SoryCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`sorycode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du sorycode in deiner Organisation einsetzt.