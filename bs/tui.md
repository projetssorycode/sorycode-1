...
SoryCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje SoryCode pokreće TUI za trenutni direktorij.
...
Kada koristite SoryCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u SoryCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz SoryCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `sorycode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `SORYCODE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
