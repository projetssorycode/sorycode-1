...
SoryCode Zen je lista testiranih i provjerenih modela koje obezbjeduje SoryCode tim.

:::note
SoryCode Zen je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u SoryCode. Prijavite se u SoryCode Zen i uzmete API kljuc. Ovo je **potpuno opcionalno** i ne morate ga koristiti da biste koristili SoryCode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s SoryCode.
:::
...
SoryCode Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

SoryCode Zen radi kao i svaki drugi provajder u SoryCode.

1. Prijavite se na **<a href={console}>SoryCode Zen</a>**, dodajte billing podatke i kopirajte API kljuc.
2. U TUI-ju pokrenite `/connect`, izaberite SoryCode Zen i zalijepite API kljuc.
...
[model id](/docs/config/#models) u SoryCode konfiguraciji koristi format `sorycode/<model-id>`. Na primjer, za GPT 5.2 Codex u konfiguraciji koristite `sorycode/gpt-5.2-codex`.
...
- MiniMax M2.5 Free je dostupan na SoryCode ograniceno vrijeme. Tim koristi taj period za prikupljanje povratnih informacija i poboljsanje modela.
- Big Pickle je stealth model koji je besplatan na SoryCode ograniceno vrijeme. Tim koristi taj period za prikupljanje povratnih informacija i poboljsanje modela.
...
4. Obezbijedimo **bez lock-ina** tako da Zen mozete koristiti sa bilo kojim coding agentom, uz slobodu koristenja drugih provajdera u SoryCode.