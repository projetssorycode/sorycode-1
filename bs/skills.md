Agent skills omogucavaju SoryCode da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
SoryCode pretrazuje ove lokacije:

- Konfiguracija projekta: `.sorycode/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/sorycode/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, SoryCode ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.sorycode/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/sorycode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.sorycode/skills/git-release/SKILL.md` ovako:
...
SoryCode navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `sorycode.json`:
...
**Za ugradene agente** (u `sorycode.json`):
