...
Kreiraj `.sorycode/commands/test.md`:
...
Možete dodati prilagođene komande kroz SoryCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom SoryCode [config](/docs/config):
...
- Globalno: `~/.config/sorycode/commands/`
- Po projektu: `.sorycode/commands/`
...
SoryCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
