تتيح لك ميزة المشاركة في SoryCode إنشاء روابط عامة لمحادثات SoryCode الخاصة بك، بحيث يمكنك التعاون مع زملائك أو الحصول على المساعدة من الآخرين.
...
عند مشاركة محادثة، يقوم SoryCode بما يلي:
...
يدعم SoryCode ثلاثة أوضاع للمشاركة تتحكم في كيفية مشاركة المحادثات:

---

### يدوي (افتراضي)

افتراضيا، يستخدم SoryCode وضع المشاركة اليدوي. لا تتم مشاركة الجلسات تلقائيا، لكن يمكنك مشاركتها يدويا باستخدام الأمر `/share`:
...
لفرض ذلك على مستوى فريقك لمشروع معين، أضفه إلى ملف `sorycode.json` في مشروعك ثم قم بإدراجه في Git.
...
[تعرّف على المزيد](/docs/enterprise) حول استخدام SoryCode في مؤسستك.