...
يوجد نوعان من الوكلاء في SoryCode: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي SoryCode مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي SoryCode مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي SoryCode مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `sorycode.json`:
...
- عام: `~/.config/sorycode/agents/`
- لكل مشروع: `.sorycode/agents/`
...
إذا لم يتم تحديد temperature، يستخدم SoryCode القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات SoryCode العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات SoryCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [SoryCode Zen](/docs/zen)، فستستخدم `sorycode/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `sorycode models` لعرض قائمة بالنماذج المتاحة.
:::
