يدعم SoryCode متغيرات بيئة الوكيل (proxy) القياسية والشهادات المخصصة لبيئات الشبكات المؤسسية.

---

## الوكيل

يتبع SoryCode متغيرات بيئة الوكيل القياسية.
...
إذا كانت مؤسستك تستخدم سلطات تصديق (CA) مخصصة لاتصالات HTTPS، فقم بإعداد SoryCode ليثق بها.
