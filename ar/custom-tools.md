الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في sorycode مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.sorycode/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/sorycode/tools/`.
