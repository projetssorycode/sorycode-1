...
SoryCode Zen هي قائمة بالنماذج التي اختبرها فريق SoryCode وتحقّق منها.

:::note
SoryCode Zen متاح حاليا بنسخة تجريبية.
:::

يعمل Zen مثل أي مزوّد آخر في SoryCode. تسجّل الدخول إلى SoryCode Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام SoryCode.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع SoryCode.
:::
...
SoryCode Zen هو بوابة للذكاء الاصطناعي تتيح لك الوصول إلى هذه النماذج.

---

## كيف يعمل

يعمل SoryCode Zen مثل أي مزوّد آخر في SoryCode.

1. تسجّل الدخول إلى **<a href={console}>SoryCode Zen</a>**، وتضيف تفاصيل الفوترة، ثم تنسخ مفتاح API.
2. تشغّل الأمر `/connect` في واجهة TUI، وتختار SoryCode Zen، ثم تلصق مفتاح API.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات SoryCode الصيغة `sorycode/<model-id>`.
على سبيل المثال، بالنسبة إلى GPT 5.2 Codex ستستخدم `sorycode/gpt-5.2-codex` في إعداداتك.
...
- MiniMax M2.5 Free متاح على SoryCode لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على SoryCode لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
4. عدم فرض **أي ارتباط حصري (lock-in)** عبر تمكينك من استخدامه مع أي عامل برمجة آخر، مع إتاحة استخدام أي مزوّد آخر مع SoryCode أيضا.