Agentferdigheter lar SoryCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går SoryCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
SoryCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `sorycode.json`:
