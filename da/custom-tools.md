Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med sorycodes [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.sorycode/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/sorycode/tools/`.
