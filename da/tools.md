...
Her er alle de innebygde verktøyene som er tilgængelige i SoryCode.
...
:::note
Dette verktøyet er bare tilgængelig når `SORYCODE_EXPERIMENTAL_LSP_TOOL=true` (eller `SORYCODE_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger SoryCode-leverandøren eller når miljøvariabelen `SORYCODE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
