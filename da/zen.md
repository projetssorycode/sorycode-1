...
SoryCode Zen er en liste over testede og verificerede modeller leveret af SoryCode-teamet.

:::note
SoryCode Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i SoryCode. Du logger på SoryCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med SoryCode.
:::
...
SoryCode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

SoryCode Zen fungerer som alle andre udbydere i SoryCode.

1. Du logger på **<a href={console}>SoryCode Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger SoryCode Zen og indsætter API-nøglen.
...
[model-id](/docs/config/#models) i SoryCode-konfigurationen
bruger formatet `sorycode/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `sorycode/gpt-5.2-codex` i din konfiguration.
...
- MiniMax M2.5 Gratis er tilgængelig på SoryCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på SoryCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede SoryCode Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med SoryCode også.