...
Der er to typer agenter i SoryCode; primære agenter og subagenter.
...
SoryCode leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
SoryCode leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

SoryCode leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `sorycode.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger SoryCode modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale SoryCode-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din SoryCode-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [SoryCode Zen](/docs/zen), vil du bruge `sorycode/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `sorycode models` for at se en liste over de tilgængelige modeller.
:::
