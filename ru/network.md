sorycode поддерживает стандартные переменные среды прокси-сервера и пользовательские сертификаты для сетевых сред предприятия.

---

## Прокси

sorycode учитывает стандартные переменные среды прокси.
...
Если ваше предприятие использует собственные центры сертификации для HTTPS-соединений, настройте sorycode, чтобы доверять им.
