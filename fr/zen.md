...
SoryCode Zen est une liste de modèles testés et vérifiés fournie par l'équipe SoryCode.

:::note
SoryCode Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans SoryCode. Vous vous connectez à SoryCode Zen et obtenez votre clé API. C'est **complètement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser SoryCode.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec SoryCode.
:::
...
SoryCode Zen est une passerelle IA qui vous donne accès à ces modèles.

---

## Comment ça marche

SoryCode Zen fonctionne comme n'importe quel autre fournisseur dans SoryCode.

1. Vous vous connectez à **<a href={console}>SoryCode Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez SoryCode Zen et collez votre clé API.
...
Le [id du modèle](/docs/config/#models) dans votre configuration SoryCode utilise le format `sorycode/<model-id>`. Par exemple, pour GPT 5.2 Codex, vous devez utilisez `sorycode/gpt-5.2-codex` dans votre configuration.
...
- MiniMax M2.5 Free est disponible sur SoryCode pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Big Pickle est un modèle furtif gratuit sur SoryCode pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
...
Nous avons créé SoryCode Zen pour :
...
4. N'ayez **aucun verrouillage** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et laissez-vous toujours utiliser n'importe quel autre fournisseur avec SoryCode également.