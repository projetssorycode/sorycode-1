import { d as createAstro, c as createComponent, r as renderComponent, b as renderTemplate, e as renderSlot } from './astro/server_CIm_2tw6.mjs';
import { Base64 } from 'js-base64';
import { H as HeadConfigSchema, u as urlToSlug, s as slugToLocaleData, g as getSidebarFromConfig, a as getSidebar, b as getSiteTitle, c as getToC, d as getSiteTitleHref, e as getPrevNextLinks, f as getHead, h as attachRouteDataAndRunMiddleware, $ as $$Page } from './middleware_DsWbm0-W.mjs';
import { s as stripLeadingAndTrailingSlashes, g as getCollectionPathFromRoot, p as project, a as starlightConfig } from './translations_DqOMRW0j.mjs';
import { I as Icons, a as I18nBadgeConfigSchema, B as BadgeConfigSchema, p as parseAsyncWithFriendlyErrors, b as parseWithFriendlyErrors } from './Code_BKjdNvdG.mjs';
import { u as unionType, b as booleanType, s as stringType, o as objectType, n as numberType, e as enumType, r as recordType, a as undefinedType, l as lazyType, d as dateType, c as custom } from './types_DZQNl0rU.mjs';
...
async function getUserDocsSchema() {
  const userCollections = (await import('./collection-config_CmHN-DwW.mjs')).collections;
...
}, "C:/Users/keita/Desktop/sory/sorycode/node_modules/.bun/@astrojs+starlight@0.34.3+53c1c0175f5fc11b/node_modules/@astrojs/starlight/components/StarlightPage.astro", void 0);
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const messages = {
    ...
    sorycode_version: tx("share.sorycode_version"),
    sorycode_name: tx("share.sorycode_name"),
  ...
  const ogImage = `${config.socialCard}/sorycode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${id}`;
  ...
  } }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Share", null, { "id": id, "api": apiUrl, "info": data.info, "messages": messages, "client:only": "solid", "client:component-hydration": "only", "client:component-path": "C:/Users/keita/Desktop/sory/sorycode/packages/web/src/components/Share.tsx", "client:component-export": "default" })} ` })} `;
}, "C:/Users/keita/Desktop/sory/sorycode/packages/web/src/pages/s/[id].astro", void 0);
const $$file = "C:/Users/keita/Desktop/sory/sorycode/packages/web/src/pages/s/[id].astro";
const $$url = "/sorycode-1/s/[id]";
