import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, p as RenderUndefinedEntryError, q as escape, u as unescapeHTML, b as renderTemplate, a as AstroUserError, t as renderUniqueStylesheet, v as renderScriptElement, w as createHeadAndContent, r as renderComponent } from './astro/server_CIm_2tw6.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BR9K7bLb.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/sorycode-1", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://projetssorycode.github.io/sorycode-1", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CL8UVPhX.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_ZlI8OuEx.mjs');
...
export { CONTENT_LAYER_TYPE as C, DEFAULT_OUTPUT_FORMAT as D, VALID_SUPPORTED_FORMATS as V, appendForwardSlash as a, getEntry as b, DEFAULT_HASH_PROPS as c, defineCollection as d, getCollection as g, isRemotePath as i, joinPaths as j, pLimit as p, renderEntry as r, slash as s };
