import { s as slash, p as pLimit, C as CONTENT_LAYER_TYPE, d as defineCollection } from './_astro_content_DkB4wZrj.mjs';
...
import { z as getDefaultExportFromCjs, W as bold, X as green } from './astro/server_CIm_2tw6.mjs';
import require$$1, { sep, basename, dirname, resolve, normalize, relative, posix } from 'path';
import './_astro_assets_CL8UVPhX.mjs';
import { o as objectType, s as stringType, u as unionType, f as arrayType, r as recordType, g as anyType, h as literalType, b as booleanType, i as functionType, t as tupleType, j as unknownType } from './types_DZQNl0rU.mjs';
import { existsSync, promises } from 'node:fs';
import * as nativeFs from 'fs';
import nativeFs__default from 'fs';
import { fileURLToPath } from 'url';
import { createRequire } from 'module';
import { g as getCollectionPathFromRoot, l as i18nSchema } from './translations_DqOMRW0j.mjs';
import { d as docsSchema } from './_id__tKCqhTIU.mjs';
...
const en = {
  ...
  "app.lander.images.tui.caption": "sorycode TUI with the tokyonight theme",
  "app.lander.images.tui.alt": "sorycode TUI with the tokyonight theme",
  "app.lander.images.vscode.caption": "sorycode in VS Code",
  "app.lander.images.vscode.alt": "sorycode in VS Code",
  "app.lander.images.github.caption": "sorycode in GitHub",
  "app.lander.images.github.alt": "sorycode in GitHub",
  "share.meta_description": "sorycode - The AI coding agent built for the terminal.",
  ...
  "share.sorycode_version": "sorycode version",
  "share.sorycode_name": "sorycode",
  "share.models": "Models",
  "share.cost": "Cost",
