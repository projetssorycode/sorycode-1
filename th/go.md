...
SoryCode Go คือการสมัครสมาชิกราคาประหยัดเพียง **$10/เดือน** ที่ให้คุณเข้าถึงโมเดลการเขียนโค้ดแบบเปิดยอดนิยมได้อย่างน่าเชื่อถือ

:::note
ขณะนี้ SoryCode Go อยู่ในช่วงเบต้า
:::

Go ทำงานเหมือนกับผู้ให้บริการรายอื่นใน SoryCode คุณสมัครสมาชิก SoryCode Go และรับคีย์ API ของคุณ มันเป็น**ตัวเลือกเสริมทั้งหมด** และคุณไม่จำเป็นต้องใช้มันเพื่อใช้งาน SoryCode
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่เลือกสรรแล้วซึ่งทำงานได้ดีกับ SoryCode
:::
...
SoryCode Go ให้คุณเข้าถึงโมเดลเหล่านี้ในราคา **$10/เดือน**

---

## วิธีการทำงาน

SoryCode Go ทำงานเหมือนกับผู้ให้บริการรายอื่นใน SoryCode

1. ลงชื่อเข้าใช้ **<a href={console}>SoryCode Zen</a>** สมัครสมาชิก Go และคัดลอกคีย์ API ของคุณ
2. รันคำสั่ง `/connect` ใน TUI เลือก `SoryCode Go` และวางคีย์ API ของคุณ
3. รัน `/models` ใน TUI เพื่อดูรายชื่อโมเดลที่สามารถใช้งานได้ผ่าน Go

:::note
สมาชิกเพียงหนึ่งคนต่อพื้นที่ทำงาน (Workspace) เท่านั้นที่สามารถสมัครสมาชิก SoryCode Go ได้
:::
...
SoryCode Go มีขีดจำกัดดังต่อไปนี้:
...
SoryCode Go เป็นแผนการสมัครสมาชิกราคา **$10/เดือน** ด้านล่างคือราคา**ต่อ 1 ล้านโทเค็น**
...
[รหัสโมเดล](/docs/config/#models) ในการกำหนดค่า SoryCode ของคุณใช้รูปแบบ `sorycode-go/<model-id>` ตัวอย่างเช่น สำหรับ Kimi K2.5 คุณจะใช้ `sorycode-go/kimi-k2.5` ในการกำหนดค่าของคุณ
...
4. **ไม่มีการผูกมัด** โดยอนุญาตให้คุณใช้ผู้ให้บริการรายอื่นกับ SoryCode ได้เช่นกัน