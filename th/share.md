คุณลักษณะการแชร์ของ SoryCode ช่วยให้คุณสร้างลิงก์สาธารณะไปยังการสนทนา SoryCode ของคุณ เพื่อให้คุณสามารถทำงานร่วมกับเพื่อนร่วมทีมหรือรับความช่วยเหลือจากผู้อื่นได้
...
เมื่อคุณแบ่งปันการสนทนา SoryCode:
...
SoryCode รองรับโหมดการแชร์สามโหมดที่ควบคุมวิธีการแชร์การสนทนา:

---

### Manual (ค่าเริ่มต้น)

ตามค่าเริ่มต้น SoryCode จะใช้โหมดการแชร์ด้วยตนเอง เซสชันจะไม่ถูกแชร์โดยอัตโนมัติ แต่คุณสามารถแชร์ได้ด้วยตนเองโดยใช้คำสั่ง `/share`:
...
หากต้องการบังคับใช้สิ่งนี้กับทีมของคุณสำหรับโปรเจ็กต์ที่กำหนด ให้เพิ่มลงใน `sorycode.json` ในโปรเจ็กต์ของคุณและตรวจสอบใน Git
...
[เรียนรู้เพิ่มเติม](/docs/enterprise) เกี่ยวกับการใช้ sorycode ในองค์กรของคุณ