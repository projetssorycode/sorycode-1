...
สร้าง `.sorycode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ SoryCode:
...
- ระดับผู้ใช้ (Global): `~/.config/sorycode/commands/`
- ระดับโปรเจ็กต์: `.sorycode/commands/`
...
SoryCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
