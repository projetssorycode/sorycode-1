...
คำสั่ง `sorycode serve` รันเซิร์ฟเวอร์ HTTP ที่ไม่มีหัวซึ่งเปิดเผยตำแหน่งข้อมูล OpenAPI ที่ไคลเอนต์ sorycode สามารถใช้ได้
...
| `--mdns-domain` | ชื่อโดเมนที่กำหนดเองสำหรับบริการ mDNS    | `sorycode.local` |
...
ตั้งค่า `SORYCODE_SERVER_PASSWORD` เพื่อปกป้องเซิร์ฟเวอร์ด้วย HTTP การตรวจสอบสิทธิ์ขั้นพื้นฐาน ชื่อผู้ใช้มีค่าเริ่มต้นเป็น `sorycode` หรือตั้งค่า `SORYCODE_SERVER_USERNAME` เพื่อแทนที่ชื่อผู้ใช้ สิ่งนี้ใช้ได้กับทั้ง `sorycode serve` และ `sorycode web`
...
เมื่อคุณรัน `sorycode` มันจะเริ่มต้น TUI และเซิร์ฟเวอร์ โดยที่ TUI คือ
...
:::tip
ใช้เซิร์ฟเวอร์ sorycode เพื่อโต้ตอบกับ sorycode โดยทางโปรแกรม
:::

สถาปัตยกรรมนี้ช่วยให้ sorycode รองรับไคลเอนต์หลายตัว และช่วยให้คุณสามารถโต้ตอบกับ sorycode โดยทางโปรแกรมได้

คุณสามารถเรียกใช้ `sorycode serve` เพื่อเริ่มเซิร์ฟเวอร์แบบสแตนด์อโลน ถ้าคุณมี
sorycode TUI ทำงาน `sorycode serve` จะเริ่มเซิร์ฟเวอร์ใหม่
...
ตำแหน่งข้อมูล [`/tui`](#tui) สามารถใช้เพื่อขับเคลื่อน TUI ผ่านเซิร์ฟเวอร์ ตัวอย่างเช่น คุณสามารถกรอกข้อมูลล่วงหน้าหรือเรียกใช้พร้อมท์ได้ การตั้งค่านี้ถูกใช้โดยปลั๊กอิน SoryCode [IDE](/docs/ide)
...
เซิร์ฟเวอร์ sorycode เปิดเผย API ต่อไปนี้
