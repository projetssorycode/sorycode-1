Agentferdigheter lar SoryCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
sorycode søker etter disse stedene:

- Prosjektkonfigurasjon: `.sorycode/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/sorycode/skills/<name>/SKILL.md`
...
For prosjektlokale stier går sorycode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.sorycode/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/sorycode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.sorycode/skills/git-release/SKILL.md` slik:
...
sorycode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `sorycode.json`:
...
**For innebygde agenter** (i `sorycode.json`):
