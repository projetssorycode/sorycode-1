...
SoryCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre SoryCode starter TUI for gjeldende katalog.
...
Når du bruker SoryCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til SoryCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt SoryCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `sorycode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `SORYCODE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
