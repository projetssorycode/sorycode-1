...
SoryCode JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere SoryCode programmatisk.
...
Opprett en forekomst av SoryCode:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `sorycode.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av SoryCode, kan du opprette en klientforekomst for å koble til den:
