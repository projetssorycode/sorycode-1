...
SoryCode Go er et lavkostnadsabonnement til **$10/måned** som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
SoryCode Go er for tiden i beta.
:::

Go fungerer som enhver annen leverandør i SoryCode. Du abonnerer på SoryCode Go og
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer bra med SoryCode.
:::
...
SoryCode Go gir deg tilgang til disse modellene for **$10/måned**.

---

## Hvordan det fungerer

SoryCode Go fungerer som enhver annen leverandør i SoryCode.

1. Du logger deg inn på **<a href={console}>SoryCode Zen</a>**, abonnerer på Go, og
   kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI-en, velger `SoryCode Go`, og limer inn
   API-nøkkelen din.
3. Kjør `/models` i TUI-en for å se listen over modeller tilgjengelig gjennom Go.

:::note
Bare ett medlem per arbeidsområde kan abonnere på SoryCode Go.
:::
...
SoryCode Go inkluderer følgende grenser:
...
SoryCode Go er et **$10/måned** abonnementsplan. Nedenfor er prisene **per 1M tokens**.
...
[Modell-ID-en](/docs/config/#models) i din SoryCode-konfigurasjon
bruker formatet `sorycode-go/<model-id>`. For eksempel, for Kimi K2.5, ville du
bruke `sorycode-go/kimi-k2.5` i konfigurasjonen din.
...
Vi opprettet SoryCode Go for å:
...
4. Ha **ingen innlåsing** ved å tillate deg å bruke hvilken som helst annen leverandør med SoryCode også.