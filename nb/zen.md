...
SoryCode Zen er en liste over testede og verifiserte modeller levert av SoryCode-teamet.

:::note
SoryCode Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i SoryCode. Du logger på SoryCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med SoryCode.
:::
...
SoryCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

SoryCode Zen fungerer som alle andre leverandører i SoryCode.

1. Du logger på **<a href={console}>SoryCode Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger SoryCode Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i SoryCode-konfigurasjonen
bruker formatet `sorycode/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `sorycode/gpt-5.2-codex` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på SoryCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på SoryCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
Vi opprettet SoryCode Zen for å:
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med SoryCode også.