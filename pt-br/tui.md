...
O sorycode fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar sorycode inicia o TUI para o diretório atual.
...
Ao usar o TUI do sorycode, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao sorycode. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do sorycode. _Aliases_: `/quit`, `/q`
...
Isso é separado do `sorycode.json`, que configura o comportamento do servidor/runtime.
...
Use `SORYCODE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
