...
Crea `.sorycode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di SoryCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di SoryCode:
...
- Globale: `~/.config/sorycode/commands/`
- Per progetto: `.sorycode/commands/`
...
sorycode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
