...
SoryCode Zen è una lista di modelli testati e verificati dal team di SoryCode.

:::note
SoryCode Zen è attualmente in beta.
:::

Zen funziona come qualunque altro provider in SoryCode. Accedi a SoryCode Zen e ottieni la tua chiave API. È **completamente opzionale**: non devi usarlo per usare SoryCode.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con SoryCode.
:::
...
SoryCode Zen e un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

SoryCode Zen funziona come qualunque altro provider in SoryCode.

1. Accedi a **<a href={console}>SoryCode Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona SoryCode Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di SoryCode usa il formato `sorycode/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `sorycode/gpt-5.2-codex` nella config.
...
- MiniMax M2.5 Free e disponibile su SoryCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth gratuito su SoryCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato SoryCode Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con SoryCode.