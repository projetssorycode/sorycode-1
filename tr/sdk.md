...
sorycode JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
sorycode'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `sorycode.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir sorycode örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
