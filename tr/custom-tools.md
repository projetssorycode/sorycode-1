Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. sorycode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.sorycode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/sorycode/tools/` içine yerleştirerek.
