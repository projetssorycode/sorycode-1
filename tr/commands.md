...
`.sorycode/commands/test.md` oluştur:
...
sorycode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

sorycode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/sorycode/commands/`
- Proje başına: `.sorycode/commands/`
...
sorycode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
