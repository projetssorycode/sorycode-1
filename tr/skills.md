Ajan becerileri, sorycode'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
sorycode su konumlari tarar:

- Proje konfigurasyonu: `.sorycode/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/sorycode/skills/<name>/SKILL.md`
...
Proje yerel yollarinda sorycode, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.sorycode/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/sorycode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.sorycode/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
sorycode, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`sorycode.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`sorycode.json` icinde):
