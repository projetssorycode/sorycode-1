...
SoryCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół SoryCode.

:::note
SoryCode Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w SoryCode. Logujesz się do SoryCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z SoryCode.
:::
...
SoryCode Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

SoryCode Zen działa jak każdy inny dostawca w SoryCode.

1. Logujesz się do **<a href={console}>SoryCode Zen</a>**, dodajesz dane rozliczeniowe
   i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz SoryCode Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji SoryCode
używa formatu `sorycode/<model-id>`. Na przykład w przypadku GPT 5.2 Codex użyłbyś
`sorycode/gpt-5.2-codex` w swojej konfiguracji.
...
- MiniMax M2.5 Free jest dostępny w SoryCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w SoryCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
4. Nie **mieć blokady** (no lock-in), umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalać na korzystanie z dowolnego innego dostawcy w SoryCode.