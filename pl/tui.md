...
sorycode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie sorycode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI sorycode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do sorycode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij sorycode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `sorycode.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `SORYCODE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
