...
Utwórz `.sorycode/commands/test.md`:
...
Możesz zdefiniować polecenia w `sorycode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji sorycode:
...
- Globalnie: `~/.config/sorycode/commands/`
- Na projekt: `.sorycode/commands/`
...
sorycode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
