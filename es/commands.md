...
Crear `.sorycode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración SoryCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su SoryCode [config](/docs/config):
...
- Por proyecto: `.sorycode/commands/`
...
sorycode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
