...
SoryCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar SoryCode se inicia TUI para el directorio actual.
...
Cuando utilice SoryCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a SoryCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de SoryCode. _Alias_: `/quit`, `/q`
...
Esto es independiente de `sorycode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `SORYCODE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
