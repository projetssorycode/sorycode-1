...
El SDK sorycode JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar sorycode mediante programación.
...
Cree una instancia de sorycode:
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `sorycode.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de sorycode, puede crear una instancia de cliente para conectarse a ella:
