...
Create `.sorycode/commands/test.md`:
...
You can add custom commands through the SoryCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your SoryCode [config](/docs/config):
...
sorycode includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
