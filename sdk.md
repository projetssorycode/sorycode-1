...
The sorycode JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control sorycode programmatically.
...
Create an instance of sorycode:
...
You can pass a configuration object to customize behavior. The instance still picks up your `sorycode.json`, but you can override or add configuration inline:
...
If you already have a running instance of sorycode, you can create a client instance to connect to it:
